...
java $APP_OPTS $LOG_CONFIG $DATASOURCE_URL $DATASOURCE_USERNAME $DATASOURCE_PASSWORD $DATASOURCE_DRIVER $JPA_GENERATE_DDL $JPA_DATASOURCE_PLATFORM -jar target/hotel-management-service-0.0.1-SNAPSHOT.jar
